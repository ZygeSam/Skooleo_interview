...
<html lang="en">
  <head>
    ...
    <title> Author's Dashboard *ZBlog</title>
...
<meta name="theme-color" content="#563d7c">
  ...
  <body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 mb-5 shadow">
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="auth.dashboard.php">
